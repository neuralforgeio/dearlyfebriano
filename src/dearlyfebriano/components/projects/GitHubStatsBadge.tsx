  ...
  if (variant === "compact") {
    return (
      <a
        ...
        className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-black/50 px-2.5 py-1 font-mono text-[9px] uppercase tracking-wider text-muted-foreground backdrop-blur-md transition-colors hover:border-primary/40 hover:text-foreground"
      >
