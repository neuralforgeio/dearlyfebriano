        ...
        {sections.map((section, index) => {
          ...
          return (
            <FadeIn
              ...
              className="h-full"
            >
              <div className="group h-full rounded-xl border border-border bg-card p-5 transition-all duration-300 hover:border-foreground/25 sm:p-6">
                <div className="flex items-start gap-4">
                  {/* Icon */}

                  <div className="grid size-11 shrink-0 place-items-center rounded-xl border border-border bg-secondary text-muted-foreground transition-transform duration-300">
                ...
                <div className="mt-5 flex items-center gap-2 border-t border-border pt-4 font-mono text-[10px] uppercase tracking-wider text-muted-foreground">
      ...
      {data.decisions.length > 0 && (
        <FadeIn delay={0.1} className="mt-6">
          <div className="rounded-xl border border-border bg-card p-5 sm:p-6">
            <div className="flex items-start gap-4">
              <div className="grid size-11 shrink-0 place-items-center rounded-xl border border-border bg-secondary text-muted-foreground">
            ...
            <ul className="mt-5 grid gap-3 sm:grid-cols-2">
              {data.decisions.map((decision, index) => (
                <li
                  key={decision}
                  className="group rounded-xl border border-border bg-background/30 p-4 transition-colors hover:border-foreground/25 hover:bg-background/50"
                >
